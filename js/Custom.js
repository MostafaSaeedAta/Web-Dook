$(document).ready(function () {
  ...
  //shopPage
  var swiper = new Swiper('.shopPage-container', {
    spaceBetween: 0,
    centeredSlides: true,
    loop: true,
    // effect: 'fade',
  ...
  //product slider
  var swiper = new Swiper('.providersSlider', {
    navigation: {
      nextEl: '.swiper-button-next',
      prevEl: '.swiper-button-prev',
    },
  ...
  //product slider
  var swiper = new Swiper('.favSlider', {
    navigation: {
      nextEl: '.swiper-button-next',
      prevEl: '.swiper-button-prev',
    },
  ...
  var swiper = new Swiper('.DepartmentsContainer', {
    navigation: {
      nextEl: '.swiper-button-next',
      prevEl: '.swiper-button-prev',
    },
  ...
  const navLi = document.querySelectorAll(".DepartmentsContainer .swiper-wrapper a");
  window.onscroll = () => {
    var current = "";
